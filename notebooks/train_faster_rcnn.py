...
override_path_best = f"{PATH}/data/all_models/model_best_cardinalidades_fasterrcnn.pt"
override_path_final = f"{PATH}/data/all_models/model_final_cardinalidades_fasterrcnn.pt"
